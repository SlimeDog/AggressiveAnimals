...
public class NPCHookManager extends OneOfDelegateNPCHook {
    ...
    private static final NPCHook ELITE__MOBS_HOOK = new OneOfDelegateNPCHook("EliteMobs",
            new MetadataNPCHook("Elitemobs_NPC", "Elitemobs_NPC"), new MetadataNPCHook("Elitemob", "Elitemob"));

    public NPCHookManager() {
        super(COMBINED_HOOKS, CITIZENS_HOOK, SHOPKEEPER_HOOK, INFERNAL_MOBS_HOOK, ELITE__MOBS_HOOK);
    }
